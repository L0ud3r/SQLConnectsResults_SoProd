            ...
            this.each(function () {
                ...
                function attachWheel() {
                    if (window.addEventListener) {
                        ...
                        window.addEventListener('mousewheel', _onWheelWindow, { passive: false });
                        window.addEventListener('DOMMouseScroll', _onWheelWindow, { passive: false });
